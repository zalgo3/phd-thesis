...
\begin{enumerate}
    \item In \zcref{sec:merit}, we have proposed three merit functions for non-smooth multi-objective optimization:
        ...
        \end{enumerate*}
        First, we have shown that they satisfy the properties as merit functions and proved the lower semi-continuity of the~\zcref{sec:conclusions:merit:gap} and the locally Lipschitz continuity of the~\zcref{sec:conclusions:merit:reg_gap,sec:conclusions:merit:reg_lin_gap}.
