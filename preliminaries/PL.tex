...
\begin{document}
\section{Polyak-{\L}ojasiewicz (PL) inequality and proximal-PL inequality} \zlabel{sec:preliminaries:PL}
...
Assume that \zcref{eq:differentiable_OP} has a optimal solution, and let~$f^*$ denote the optimal function value.
