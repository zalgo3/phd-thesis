...
When $\hat{g}_i$ and $\mathcal{U}_i$ have some special structure, the constraints can be written as explicit formulae by using the duality of~\zcref{eq:g_i}.
...
If strong duality holds, then we see that the subproblem \zcref{eq:pgm_subproblem} is equivalent to
