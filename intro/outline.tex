...
\Cref{sec:pgm} develops the proximal gradient method for composite multi-objective optimization problems, describes its convergence, convergence rate, applications to robust multi-objective optimization, and performs numerical experiments.
\Cref{sec:acc_pgm} presents its acceleration applicable with \emph{convex} composite objectives: the accelerated proximal gradient method or Fast Iterative Shrinkage-Thresholding Algorithm (FISTA) and provides similar discussions.
