...
\begin{example} \zlabel{ex:descent}
    \begin{description}
        ...
        \item[The projected gradient method~\cite{Grana-Drummond2004,Fukuda2013}] For a convex-constrained smooth multi-objective optimization, i.e.,~$C \subseteq \setR^n$ is non-empty, closed, and convex, and every~$F_i$ is differentiable in~\zcref{eq:MOO}, we can use the projected gradient method described by
