...
\zcref{sec:merit:merit} proposes different merit functions for multi-objective optimization with continuous, convex, and composite objectives, respectively, along with methods for evaluating the function values, the differentiability, and the stationary point properties.
Furthermore, sufficient conditions for them to be level-bounded and to provide error bounds are given in \zcref{sec:merit:lb,sec:merit:eb}, respectively, introducing the extension of the proximal-PL inequality~\cite{Chambolle2015} to multi-objective problems.
